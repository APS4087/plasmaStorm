...
Square::Square(std::string name, bool containsWarpSpace, const int vertices[][2])
...
double Square::computeArea() const
{
    ...
    int sideLength = std::max(maxX - minX, maxY - minY);
...
std::string Square::toString() const
{
    ...
    return ShapeTwoD::toString() + ", Type: Square, " + verticesStr;
}

std::vector<std::pair<int, int>> Square::getVertices() const
{
